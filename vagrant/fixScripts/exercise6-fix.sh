...
then
    ...
    cat ~/.ssh/id_rsa | sudo tee /root/.ssh/id_rsa && sudo chmod 600 /root/.ssh/id_rsa
    cat ~/.ssh/authorized_keys | sudo tee -a /root/.ssh/authorized_keys && sudo chmod 600 /root/.ssh/authorized_keys
else
